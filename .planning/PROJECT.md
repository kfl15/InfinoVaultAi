...
- OK On-device chat with a local SLM (via `smollm/src/main/java/io/shubham0204/smollm/*` + `llama.cpp`)
- OK Local model download/import flows (see `app/src/main/java/io/shubham0204/smollmandroid/ui/screens/model_download/*`)
